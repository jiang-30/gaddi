<template>
  <el-dialog v-model="visible" title="角色权限" width="800px" close-on-click-modal append-to-body destroy-on-close>
    <template #default>
      <el-tree ref="treeRef" :data="treeData" node-key="id" :props="{ label: 'title' }" show-checkbox
